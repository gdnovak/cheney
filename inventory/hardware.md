...
|---|---|---|---|---|---:|---|---|---|---|---|---|---|---|
| rb14-2017 | Razer Blade 14 (2017) | 2017 | Primary baremetal agent host (`rb1-fedora`) | Intel Core i7-7700HQ (4c/8t) | 16 | 476.9G NVMe (`SAMSUNG MZVLW512HMJP-00000`) | Internal Intel HD 630 + NVIDIA GTX 1060 Mobile (`10de:1c20`) + external GTX 1060 6GB via TB (`10de:1c03`) | TB3+ | Medium | Fedora Linux 43 Server (`192.168.5.107/22`, `enp0s20f0u6`) | Stable eGPU-ready environment host | Active; `rb1-admin` key SSH verified; WoL persistent (`magic`/`g`); internal+external NVIDIA GPUs visible in `nvidia-smi`; fallback99 persisted across reboot; AI runtime artifacts removed from host | 2026-02-16 19:33 EST |
