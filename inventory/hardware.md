...
|---|---|---|---|---|---:|---|---|---|---|---|---|---|---|
| rb14-2017 | Razer Blade 14 (2017) | 2017 | Primary baremetal agent host (`rb1-fedora`) | Intel Core i7-7700HQ (4c/8t) | 16 | 476.9G NVMe (`SAMSUNG MZVLW512HMJP-00000`) | Internal Intel HD 630 + NVIDIA GTX 1060 Mobile (`10de:1c20`) | TB3+ | Medium | Fedora Linux 43 Server (`192.168.5.107/22`, `enp0s20f0u6`) | Stable eGPU-ready AI/agent runtime host | Active; `rb1-admin` key SSH verified; WoL persistent (`magic`/`g`); NVIDIA stack loaded (`nvidia-smi` pass, driver `580.119.02`) | 2026-02-16 18:55 EST |
