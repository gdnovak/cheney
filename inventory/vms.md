...
| 220 | cheney-vessel-alpha | `rb2-pve` | n/a (temporary while `rb1` baremetal stack is validated) | Medium | Fresh backup + restore completed (`2026-02-14`) | Backup/restore migration completed (`rb1` -> `rb2`) | `vmbr0` LAN (`192.168.5.111/22`) | 2026-02-16 18:05 EST (running) | 2 | Keep on `rb2` until `rb1` eGPU + environment validation passes; AI bootstrap currently deferred |
