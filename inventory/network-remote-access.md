...
| rb14-2015 | Not reachable (host offline) | TBD after physical setup | Unknown (offline) | No battery; physical power stability risk | 2026-02-13 23:45 EST |
...
| rb14-2015 | Unknown | Not tested (offline) | Host not connected; unstable power due no battery | Smart plug + BIOS auto power-on policy (if available) |
